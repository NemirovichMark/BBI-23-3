...
namespace лаба_6_уровень_1__ноемр_1
{
    using System;
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                participant[i] = new Participant(participant[i].Surname, participant[i].Society, participant[i].FirstAttempt, participant[i].SecondAttempt);
                participant[i].Print();
            }
        }
    }
